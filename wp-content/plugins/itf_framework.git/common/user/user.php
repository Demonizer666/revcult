			...
			if ( !$user_data['user_email'] ) {
				...
				if ( !$user_data['user_login'] ) {
					...
					if( is_wp_error( $user_id ) ) {
						...
						if ( $user_data['avatar'] ) {
							update_user_meta( $user_id, 'avatar', $user_data['avatar'] );
						}
			...
			if ( !$_POST['command'] ) {
				...
				if ( !$_POST['user_data'] ) {
					...
					if ( $_POST['command'] == 'register' ) {
						$answer = self::register( $_POST['user_data'] );
					}

					else if ( $_POST['command'] == 'login' ) {
						$answer = self::login( $_POST['user_data'] );
					}

					else if ( $_POST['command'] == 'delete' ) {
						$answer = self::delete( $_POST['user_data'] );
					}
...
add_action( 'wp_ajax_nopriv_itff_user', array( 'ITFF_USER', 'ajax_handler') );
add_action( 'wp_ajax_itff_user', array( 'ITFF_USER', 'ajax_handler') );